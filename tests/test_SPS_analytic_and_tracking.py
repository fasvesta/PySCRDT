"""
#  Test of tune footprint maker example with PySCRDT to generate tune footprint
...
#### Load the sequence ####
fname_line = 'test_data/SPS_2021_Pb_ions_for_tracking.json'
...
# Generate some randomly generated tracking Qx and Qy test data 
Qx_test = np.random.normal(0.1, 0.05, 20)
Qy_test = np.random.normal(0.1, 0.05, 20)
print(Qx_test)

#### Plot the tune footprint ####
fig = plt.figure(figsize=(8, 8))
SPS_tune_footprint.generate_tune_footprint_with_tracking_data(fig, s, Qx_test, Qy_test) 
fig.savefig('test_output/SPS_Pb_tune_footprint.png', dpi=250)